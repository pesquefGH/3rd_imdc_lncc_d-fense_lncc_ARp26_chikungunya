% Validation 3: LNCC ARP26 Chikungunya forecast model (high-order AR(p) model)
...
% (from EW 01 of 2021 to EW 25 of 2024). Model order p = floor(length(data)/2)-1. 
...
ind_v3=441+52+52;  % index of the end of EW 25 of 2024 (upper bound 
% observed data for validation 3)

cc=kcc(ind_01_21:ind_v3);  % observed cases from EW 1 of 2021 to EW 25 of 2024

cc(cc==0)=0.1;  % replaces null value in cc with a small value. 
% This is because we will apply 
% a log2 function to the data values. 

lwea=79;   % number of EW to be forecast, i.e., from EW 26 of 2024 
% up to EW 52 2025 (will be cropped later to EW 40 of 2025)
...
date=S_dates(771:822);  % Sunday dates (EW) to be forecast 
...
writetable(T,['..\spreadsheets\v3_ARp26_CG_',num2str(state_code(1)),'.csv'],'Delimiter',',')
...
print(['..\plots\v3_ARp26_CG_',UF],'-dpdf')
